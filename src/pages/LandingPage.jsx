  ...
  return (
    <div className="hero">
      ...
      <p className="hero-desc">
        ვებ-პლატფორმა თეორიული კომპიუტერული მეცნიერების საფუძვლების შესასწავლად — ავტომატები,
        მათემატიკური ლოგიკა და ფორმალური გრამატიკები. მხარდაჭერილია DFA, NFA, ε-NFA და PDA მოდელები.
